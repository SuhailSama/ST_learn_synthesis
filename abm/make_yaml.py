...
def make_yaml(directory, replicate, default=True):
    ...
    os.makedirs(directory + "/yaml_parameters", exist_ok=True)
...
if __name__ == "__main__":
    ...
    cwd = os.getcwd()
    directory_to_yaml = os.path.join(cwd,"suhail_yamls")
    make_yaml(directory_to_yaml, 0)
    # make_yaml(directory_to_yaml, 1)
